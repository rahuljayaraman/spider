...
describe "Web Slinging" do
  it "should be able to hook onto sites & fetch information" do
    ...
    action1 = Action.new action: :visit, url: "http://www.google.com"
    action2 = Action.new action: :fill, field: "q", text: "Apple"
    action3 = Action.new action: :yank, div: "#resultStats"
